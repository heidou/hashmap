...
import mengka.serializable_02.flatbuffers.Table;

public class Monster extends Table {
	public static Monster getRootAsMonster(ByteBuffer _bb, int offset) {
		_bb.order(ByteOrder.LITTLE_ENDIAN);
		return (new Monster()).__init(_bb.getInt(offset) + offset, _bb);
	}
	...
	public String name() {
		int o = __offset(10);
		return o != 0 ? __string(o) : null;
	}

	public byte inventory(int j) {
		int o = __offset(14);
	...
	public Test test4(int j) {
		return test4(new Test(), j);
	}

	public Test test4(Test obj, int j) {
		int o = __offset(22);
	...
	// / an example documentation comment: this will end up in the generated
	// code multiline too
	public Monster testarrayoftables(int j) {
		return testarrayoftables(new Monster(), j);
	}
	...
	public static void startInventoryVector(FlatBufferBuilder builder,
			int numElems) {
		builder.startVector(1, numElems);
	}
	...
	public static void addTestarrayofstring(FlatBufferBuilder builder,
			int testarrayofstringOffset) {
	...
	public static void addTestarrayoftables(FlatBufferBuilder builder,
			int testarrayoftablesOffset) {
		builder.addOffset(11, testarrayoftablesOffset, 0);
	}

	public static void startTestarrayoftablesVector(FlatBufferBuilder builder,
			int numElems) {
		builder.startVector(4, numElems);
	}
